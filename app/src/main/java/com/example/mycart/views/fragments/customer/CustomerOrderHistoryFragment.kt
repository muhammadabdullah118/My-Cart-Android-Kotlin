...
import com.example.mycart.databinding.FragmentCustomerOrderHistoryBinding
...
class CustomerOrderHistoryFragment : Fragment() , View.OnClickListener , OrderListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.rvcOrder?.layoutManager = LinearLayoutManager(requireContext())
        adapter = OrderAdapter(requireContext(),this)
        binding?.rvcOrder?.adapter = adapter
